package com.uth.hn.views.listadodeempleados;
...
public class ListadodeEmpleadosView extends Div implements AfterNavigationObserver {

    Grid<Person> grid = new Grid<>();

    public ListadodeEmpleadosView() {
        addClassName("listadode-empleados-view");
        setSizeFull();
        grid.setHeight("100%");
